...
from utils.general import coco80_to_coco91_class, check_dataset, check_file, check_img_size, check_requirements, \
    box_iou, mod_non_max_suppression, scale_coords, xyxy2xywh, xywh2xyxy, set_logging, increment_path, colorstr
...
if __name__ == '__main__':
    ...
    parser.add_argument('--merge', type=bool, default=True, help='merge NMS')
    parser.add_argument('--soft', type=bool, default=True, help='soft-NMS instead of normal')
